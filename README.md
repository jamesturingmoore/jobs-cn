...
### 数据来源
本项目所有缓存数据（职业分类、薪资估算、AI暴露度评分）均来源于：
- 《中华人民共和国职业分类大典》(2022年版) - 人社部官方文件
- BOSS直聘《2024人才吸引力报告》- 公开报告
- 智联招聘《2024中国企业招聘薪酬报告》- 公开报告
- 国家统计局《中国统计年鉴2024》- 政府公开数据

**本项目未使用爬虫获取任何数据。**

### 爬虫模块
项目中包含的 `scrape.py` 等爬虫脚本为**参考代码，未经测试验证**。
如需使用爬虫功能，请：
1. 自行修改代码确保符合目标网站的 robots.txt 协议
2. 遵守相关法律法规及平台服务条款
3. 控制请求频率，避免对目标服务器造成负担
4. **使用爬虫产生的任何法律责任由使用者自行承担**

### 项目用途
本项目仅用于**学术研究和技术学习**，不得用于任何商业用途。
